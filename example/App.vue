<template>
  <div id="app">
    <github
      fill="white"
      slug="amaury-tobias/vue-simple-icons">
    </github>
    <header class="header">
      <div class="container">
      ...
      <div class="sizing">
        ...
        <div class="sizes">
          <div
            ...
            <div class="size-icon">
              <vue-js-icon :size="size"></vue-js-icon>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer class="footer">
      <div class="container">
        &copy; {{ year }} Brought by <a href="https://github.com/amaury-tobias">Amaury</a>
        thanks <a href="https://github.com/egoist">EGOIST</a>
      </div>
    </footer>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    sizeExample(size) {
      return example
        .replace('1.5x', size)
        .replace(/ICON/g, 'VueJsIcon')
        .replace(/kebab-icon/g, 'vue-js-icon')
    }
  },
  components: {
    ...icons,
